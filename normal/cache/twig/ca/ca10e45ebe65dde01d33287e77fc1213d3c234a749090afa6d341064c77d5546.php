...
class __TwigTemplate_a995540ac21272a23cd13e8f13090dbc94ecc9856d4a170d6cb2b3b0712c527e extends Twig_Template
{
    ...
    <div class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 19
            echo "                        ";
            echo $this->env->getExtension('GravTwigExtension')->safeEmailFilter($this->getAttribute($context["item"], "address", array()));
            echo " <br />
                        ";
        }
        $_parent = $context['_parent'];
